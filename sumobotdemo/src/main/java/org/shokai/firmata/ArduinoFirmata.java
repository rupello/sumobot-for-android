...
public class ArduinoFirmata{
    ...
    public void connect() throws IOException, InterruptedException{
        try{
            ...
            this.usb = availablePorts.get(0);
            this.usb.open(connection);
            this.usb.setParameters(57600, UsbSerialPort.DATABITS_8, UsbSerialPort.STOPBITS_1, UsbSerialPort.PARITY_NONE);
            Thread.sleep(3000);
        }
